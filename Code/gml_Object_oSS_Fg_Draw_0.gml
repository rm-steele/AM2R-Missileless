...
if (global.ssmode == 0)
{
    ...
    if (hidetext == 0)
    {
        ...
        if (oControl.mod_collecteditemsmap == 1 && itemcollunlock)
        {
            ...
            draw_text((view_xview[0] + 129), ((view_yview[0] + 210) + rectoffset), (string(global.btanks) + "/44"))
            if (global.ctanks > 0)
                draw_text((view_xview[0] + 211), ((view_yview[0] + 210) + rectoffset), (string(global.ctanks) + "/10"))
            if (global.ptanks > 0)
        ...
        if (oControl.mod_collecteditemsmap == 1 && itemcollunlock)
        {
            ...
            draw_text((view_xview[0] + 128), ((view_yview[0] + 209) + rectoffset), (string(global.btanks) + "/44"))
            if (global.ctanks > 0)
                draw_text((view_xview[0] + 210), ((view_yview[0] + 209) + rectoffset), (string(global.ctanks) + "/10"))
            if (global.ptanks > 0)
...
if (global.ssmode == 1)
{
    ...
    draw_text(global.percent1M, (30 - rectoffset), string(global.btanks))
    if (global.ctanks > 0)
        draw_text(global.percent1SM, (30 - rectoffset), string(global.ctanks))
    if (global.ptanks > 0)
    ...
    draw_text(global.percent2M, (29 - rectoffset), string(global.btanks))
    if (global.ctanks > 0)
        draw_text(global.percent2SM, (29 - rectoffset), string(global.ctanks))
    if (global.ptanks > 0)
