...
draw_set_color(c_black)
draw_text(19, (30 - oSubscreenMenu.rectoffset), ((string(global.playerhealth) + "Test") + string(global.maxhealth)))
draw_text(109, (30 - oSubscreenMenu.rectoffset), (string(global.btanks) + "/44"))
if (global.ctanks > 0)
    draw_text(211, (30 - oSubscreenMenu.rectoffset), string(global.ctanks))
if (global.ptanks > 0)
    draw_text(275, (30 - oSubscreenMenu.rectoffset), ((string(global.pbombs) + "/") + string(global.maxpbombs)))
draw_set_color(c_white)
draw_text(18, (29 - oSubscreenMenu.rectoffset), ((string(global.playerhealth) + "Test") + string(global.maxhealth)))
draw_text(128, (29 - oSubscreenMenu.rectoffset), (string(global.btanks) + "/44"))
if (global.ctanks > 0)
    draw_text(210, (29 - oSubscreenMenu.rectoffset), string(global.ctanks))
if (global.ptanks > 0)
